...
let AppController = class AppController {
    ...
    getHello(req) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const cookies = ((_a = req === null || req === void 0 ? void 0 : req.cookies) === null || _a === void 0 ? void 0 : _a.user) ? yield req.cookies : null;
    ...
    getCookies(req) {
        var _a, _b;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const token = ((_b = (_a = req.cookies) === null || _a === void 0 ? void 0 : _a.token) === null || _b === void 0 ? void 0 : _b.access_token)
                ? yield req.cookies.token.access_token
                : null;
            return { token };
        });
    }
...
tslib_1.__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get auth/token' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
...
], AppController.prototype, "getCookies", null);
tslib_1.__decorate([
    ...
    tslib_1.__param(1, (0, common_1.Res)({ passthrough: true })),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, typeof (_g = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _g : Object]),
...
let CategoriesService = class CategoriesService {
    ...
    findById(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const data = yield this.categoriesRepository.find({
                where: {
                    id: id,
                },
            });
...
let CommentsController = class CommentsController {
    ...
    getAll(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const comments = yield this.commentsService.findAll(+params.id);
            return comments;
        });
    }
};
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, typeof (_b = typeof comment_create_dto_1.CommentCreateDto !== "undefined" && comment_create_dto_1.CommentCreateDto) === "function" ? _b : Object]),
    tslib_1.__metadata("design:returntype", void 0)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Number, Number, typeof (_c = typeof comment_create_dto_1.CommentCreateDto !== "undefined" && comment_create_dto_1.CommentCreateDto) === "function" ? _c : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof users_entity_1.UsersEntity !== "undefined" && users_entity_1.UsersEntity) === "function" ? _a : Object)
], CommentsEntity.prototype, "user", void 0);
tslib_1.__decorate([
    (0, typeorm_1.ManyToOne)(() => news_entity_1.NewsEntity, (news) => news.comments, {
        cascade: true,
    }),
    tslib_1.__metadata("design:type", typeof (_b = typeof news_entity_1.NewsEntity !== "undefined" && news_entity_1.NewsEntity) === "function" ? _b : Object)
...
let CommentsService = class CommentsService {
    ...
    findAll(id) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const data = yield this.commentsRepository
                .find({
                relations: ['user', 'news'],
            })
                .then((result) => {
...
let NewsController = class NewsController {
    constructor(newsService, usersService, commentsService, categoriesService, mailService) {
        this.newsService = newsService;
        this.usersService = usersService;
        this.commentsService = commentsService;
        this.categoriesService = categoriesService;
    ...
    getAll(req) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const cookies = ((_a = req === null || req === void 0 ? void 0 : req.cookies) === null || _a === void 0 ? void 0 : _a.user) ? yield req.cookies : null;
            return Object.assign(Object.assign({}, news), { cookies });
        });
    }
    create(news, cover) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_g = typeof news_create_dto_1.NewsCreateDto !== "undefined" && news_create_dto_1.NewsCreateDto) === "function" ? _g : Object, typeof (_j = typeof Express !== "undefined" && (_h = Express.Multer) !== void 0 && _h.File) === "function" ? _j : Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [typeof (_k = typeof news_id_dto_1.NewsIdDto !== "undefined" && news_id_dto_1.NewsIdDto) === "function" ? _k : Object, Object]),
    tslib_1.__metadata("design:returntype", Promise)
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:type", typeof (_a = typeof categories_entity_1.CategoriesEntity !== "undefined" && categories_entity_1.CategoriesEntity) === "function" ? _a : Object)
...
let NewsService = class NewsService {
    ...
    findAll(userId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const data = yield this.newsRepository
                .find({
    ...
    edit(req, user, avatar) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                _userEntity.avatar = (avatar === null || avatar === void 0 ? void 0 : avatar.filename) && USER_PATH + avatar.filename;
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", typeof (_b = typeof Promise !== "undefined" && Promise) === "function" ? _b : Object)
], ProfileController.prototype, "getViewAll", null);
tslib_1.__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, typeof (_c = typeof user_create_dto_1.UserCreateDto !== "undefined" && user_create_dto_1.UserCreateDto) === "function" ? _c : Object, typeof (_e = typeof Express !== "undefined" && (_d = Express.Multer) !== void 0 && _d.File) === "function" ? _e : Object]),
    tslib_1.__metadata("design:returntype", Promise)
